...
- Renderizado 3D del bloque cargado en las manos del player (requiere Resource Pack).
...
3. **Recomendado**: Súbelo a un host (como Dropbox o MCPacks) y coloca el enlace en la `config.yml` del plugin para que los players lo descarguen automáticamente al entrar.
